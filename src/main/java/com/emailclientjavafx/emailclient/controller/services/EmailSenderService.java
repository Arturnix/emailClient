...
import com.emailclientjavafx.emailclient.controller.EmailSendingResult;
...
public class EmailSenderService extends Service<EmailSendingResult> {
    ...
    private List<File> attachments; //it is not inicialized here, it is inherited in the constructor
        ...
        return new Task<EmailSendingResult>() {
            ...
            protected EmailSendingResult call() {
                try {
                    ...
                    transport.close();
                    return EmailSendingResult.SUCCES;
